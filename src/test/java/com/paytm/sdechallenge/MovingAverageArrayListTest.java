...
public class MovingAverageArrayListTest {
	...
	public void testEmptyMovingAverage() {
		MovingAverage ma = new MovingAverageArrayListImpl(2L);
	...
	public void testMovingAverageScalability() {
		MovingAverage ma = new MovingAverageArrayListImpl(SCALABILITY_TEST_SAMPLE_SIZE);
		double value = 3.14;
		...
		System.out.println("repeat test took " + repeatDuration + " ms due to caching");
	}
